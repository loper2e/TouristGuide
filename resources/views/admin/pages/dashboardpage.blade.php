    ...
    <div class="flex justify-around mt-5 w-full">
        ...
        <a class="w-2/6 m-1 transform  hover:scale-105 transition duration-300 shadow-xl rounded-lg bg-white" href="#">
            <div class="p-5 ">
                ...
                <div class="ml-2 w-full flex-1">
                    <div>
                        <div class="mt-3 text-3xl font-bold leading-8">{{ $placescount }}</div>
        ...
        <a class="w-2/6 m-1 transform  hover:scale-105 transition duration-300 shadow-xl rounded-lg bg-white" href="#">
            <div class="p-5">
                ...
                <div class="ml-2 w-full flex-1">
                    <div>
                        <div class="mt-3 text-3xl font-bold leading-8">{{ $userslistcount }}</div>

                        <div class="mt-1 text-base text-gray-600">Users List</div>
                    </div>
                </div>
            </div>
        </a>
