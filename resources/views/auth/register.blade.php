            ...
            <form class="py-6 px-12" action="{{ route('user.store') }}" method="POST">
                ...
                <div class="flex  w-full">
                    <div class="mb-4 w-full">
                        <label class="block text-grey-darker text-sm mb-2">Gender
                        </label>
                        <select name="gender"
                            class="w-full max-w-xs p-3 bg-gray-50 outline-none rounded-md border focus:border-green-400">
                    ...
                    <div class="mb-4 w-full">
                        <label class="block text-grey-darker text-sm mb-2">Country
                        </label>
                        <select name="country"
                            class=" w-full max-w-xs p-3 bg-gray-50 outline-none rounded-md border focus:border-green-400">
                            <option value="">Country</option>
                            @foreach ($countries as $countrie)
                                <option value="{{ $countrie['name'] }}" {{ old('country') == $countrie['name'] ? 'selected' : '' }}>{{ $countrie['name'] }}</option>
                            @endforeach
                        </select>
                        @error('country')
                            <h1 class="text-red-400">{{ $message }}</h1>
